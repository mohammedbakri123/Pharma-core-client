...
export default function AuthLayout({ title, subtitle, children }: Props) {
  return (
    <div
      className="min-h-screen flex items-center justify-center relative bg-linear-to-br from-slate-50 via-zinc-100 to-teal-50/30 dark:from-slate-950 dark:via-zinc-900 dark:to-teal-950/20 p-4 overflow-hidden"
      dir="rtl"
    >
      ...
      <div className="w-full max-w-md space-y-6 z-10 animate-in fade-in slide-in-from-bottom-6 duration-500">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-card border border-border/40 shadow-md p-1">
            <img
              src={logo}
              alt="PharmaCore"
