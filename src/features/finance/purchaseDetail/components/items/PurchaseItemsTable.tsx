...
} from "../../../common/hooks/usePurchases";
import type { PurchaseDetailsDto, PurchaseItemDetailsDto } from "@/types";
import { PurchaseStatus } from "@/types";
import AddPurchaseItemDialog from "./addItems/AddPurchaseItemDialog";
import EditPurchaseItemDialog from "./editItems/EditPurchaseItemDialog";
...
export default function PurchaseItemsTable({
  ...
  const [editingItem, setEditingItem] = useState<PurchaseItemDetailsDto | null>(
    null,
  );
