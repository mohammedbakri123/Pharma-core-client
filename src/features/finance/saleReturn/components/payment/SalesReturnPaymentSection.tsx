...
import {
  useSaleReturnPayments,
  useAddSaleReturnPayment,
} from "@features/finance/common/hooks/usePayments";
import { useGetSaleReturnBalance } from "@features/finance/common/hooks/useSalesReturns";
...
export default function SalesReturnPaymentSection({
  saleId,
  returnId,
  isCompleted,
}: SalesReturnPaymentSectionProps) {
