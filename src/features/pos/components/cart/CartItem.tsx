...
export default function CartItem({ item }: CartItemProps) {
  ...
  return (
    <div className="group relative grid grid-cols-[minmax(0,1fr)_6.5rem_5.5rem] items-center gap-2 rounded-xl border border-border/40 bg-background/50 px-3 py-2.5 text-right transition-all duration-150 hover:border-border/80 hover:bg-background/80">
      ...
      <div className="flex items-center justify-center">
        <div className="flex h-8 items-center gap-0 rounded-full border border-border/60 bg-background p-0.5 shadow-sm">
          <button
          ...
          <span className="flex min-w-[1.75rem] items-center justify-center text-sm font-bold tabular-nums">
            {item.quantity}
          </span>
          ...
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-primary transition-all hover:bg-primary/20 disabled:opacity-30 disabled:hover:bg-primary/10"
